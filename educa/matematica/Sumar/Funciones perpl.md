...
```jsx
function generarNumeroAleatorio() { return Math.floor(Math.random() * 90) + 10; 
								...
								const num2 = generarNumeroAleatorio(); console.log(`Números generados: ${num1} y ${num2}`);
								 ...
								 const sumaUnidades = u1 + u2; const sumaDecenas = d1 + d2;
								  // Verificar si hay acarreo en las unidades 
								  let acarreoUnidades = 0; if (sumaUnidades >= 10) { acarreoUnidades = 1; } 
